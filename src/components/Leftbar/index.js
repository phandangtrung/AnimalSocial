...
import Groupavatar from "../../mocks/images/groupava.jpg";
    ...
    <div className="leftbar__container">
      ...
      <div className="invite_box ">
        <div className="img_box">
          <img className="img_groupcover" src={Groupimage} />
          <img className="img_groupavatar" src={Groupavatar} />
          <div className="group_title">Join us if the dog is your life</div>
        </div>
